...
I never thought I’d be able to build a website, but <span className="bg-yellow-100"> with Coddeit, everything just clicked. Now my site’s up and running, and it feels incredible!"</span></p>
...
<p className="text-xs font-bold text-slate-900 leading-6 ">"<span className="bg-red-300">I wasted months watching tutorials and still couldn’t create a proper website.</span> Then I gave Coddeit a shot, and everything fell into place. Building my first site and seeing it live was a game-changer!"</p>
      <div className="flex justify-center mt-6">
      <div className="avatar">
  <div className="w-12 rounded-full">
    <img src="./user.png" />
